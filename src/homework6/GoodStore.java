...
public class GoodStore {
    public static void main(String[] args) {
        Set<Good> laptops = new HashSet<>();
        laptops.add(new Good(8, 512, "Windows 10", "Black"));
        laptops.add(new Good(16, 1024, "Windows 11", "Silver"));
        laptops.add(new Good(8, 256, "Ubuntu", "Black"));
        laptops.add(new Good(32, 1024, "macOS", "Gray"));
        laptops.add(new Good(16, 512, "Windows 10", "White"));
    ...
    public static void filterLaptops(Set<Good> laptops,
                                     Map<String, Object> filters) {
        for (Good laptop : laptops) {
