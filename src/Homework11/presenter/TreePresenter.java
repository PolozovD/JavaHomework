...
public class TreePresenter {
    ...
    public TreePresenter(FamilyTree<Person> familyTree, TreeView
            view, FileOperationsImpl<Person> fileOperations) {
    ...
    public void showAllPersons() {
        view.displayPersons(familyTree.getMember());
    }
